    ...
    private:
        ...
        void kf_bfly4( cpx_type * Fout, const size_t fstride, const size_t m)
        {
            ...
            for (size_t k=0;k<m;++k) {
                scratch[0] = Fout[k+m] * _traits.twiddle(((int)k)*((int)fstride));
                scratch[1] = Fout[k+2*m] * _traits.twiddle(((int)k)*((int)fstride)*2);
                scratch[2] = Fout[k+3*m] * _traits.twiddle(((int)k)*((int)fstride)*3);
